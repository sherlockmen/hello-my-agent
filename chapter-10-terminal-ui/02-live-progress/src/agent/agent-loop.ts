/**
 * 10.2 让界面跟着执行变化 | [KEEP] agent/agent-loop.ts
 *
 * 学习目标：让界面逐条消费执行事件，模型文字和工具状态仍由已有核心产生。
 ...
 *                 +-- tui -> [CHANGED] 事件 -> RunView -> 当前文字与工具状态；结束后保留记录
