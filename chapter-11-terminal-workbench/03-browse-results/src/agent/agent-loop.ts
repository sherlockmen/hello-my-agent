/**
 * 11.3 浏览历史与工具结果 | [KEEP 来自 10.4] agent/agent-loop.ts
 *
 * 学习目标：执行继续产出结果时，用户仍可浏览旧消息或准备下一份草稿。
 ...
 *      [NEW] Ctrl+O -> 草稿 / 历史焦点；历史操作 -> 滚动 / 折叠 / 复制 -> W
 *      [NEW] 审批出现 -> H 独占输入；审批结束 -> 恢复原草稿与浏览状态
 ...
 * 运行观察：浏览旧结果时模型继续输出；准备下一份草稿不会并发开启新任务。
 */
